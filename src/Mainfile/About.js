...
const About = () => {
    let render = true
    let array = [
        'Hello! Im Anil Gollapalli, a dedicated and passionate web developer with  dynamic and responsive websites and web applications. My journey in web development started Socialtek.in with internship.',
        ...
        'Throughout my career, I have worked on a variety of projects ranging in internship from small business websites to large-scale applications. My ability to adapt and learn new technologies quickly has been a key factor in my success as a web developer. I am always looking for new challenges and opportunities to grow professionally.',
        'When Im not coding, I enjoy exploring the outdoors, reading tech blogs. I believe that a healthy work-life balance is essential for maintaining creativity and productivity.',
